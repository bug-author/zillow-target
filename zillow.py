...
Original file is located at
    https://colab.research.google.com/drive/1qzxh4kvREdPciVuN_OeiakT2CQreqZrf
"""
...
with open('/content/zillow_data.json', 'r') as inFile:
...
with open('/content/zillow_data.json', 'w') as outFile:
  json.dump(data, outFile)

with open('/content/zillow_data.json', 'a+', encoding='utf-8') as in_json:
